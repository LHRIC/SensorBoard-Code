/*
 *
 * ADS7128 Accelerometer I2C Driver
 *
 * Author:	Ananya Chintalapudi + Phil
 * Created: 5 December 2024
 *
 */

#ifndef ADS7128_I2C_DRIVER_H
#define ADS7128_I2C_DRIVER_H
...
#define ADS7128_SYSTEM_STATUS 0x81
#define ADS7128_GENERAL_CFG 0x0
#define ADS7128_DATA_CFG 0x0
...
#define ADS7128_REG_HYSTERESIS_CH1 0x24
#define ADS7128_REG_HIGH_TH_CH1 0x25
#define ADS7128_REG_EVENT_COUNT_CH1 0x26
#define ADS7128_REG_LOW_TH_CH1 0x27
#define ADS7128_REG_HYSTERESIS_CH2 0x28
#define ADS7128_REG_HIGH_TH_CH2 0x29
#define ADS7128_REG_EVENT_COUNT_CH2 0x2A
#define ADS7128_REG_LOW_TH_CH2 0x2B
#define ADS7128_REG_HYSTERESIS_CH3 0x2C
#define ADS7128_REG_HIGH_TH_CH3 0x2D
#define ADS7128_REG_EVENT_COUNT_CH3 0x2E
#define ADS7128_REG_LOW_TH_CH3 0x2F
#define ADS7128_REG_HYSTERESIS_CH4 0x30
#define ADS7128_REG_HIGH_TH_CH4 0x31
#define ADS7128_REG_EVENT_COUNT_CH4 0x32
#define ADS7128_REG_LOW_TH_CH4 0x33
#define ADS7128_REG_HYSTERESIS_CH5 0x34
#define ADS7128_REG_HIGH_TH_CH5 0x35
#define ADS7128_REG_EVENT_COUNT_CH5 0x36
#define ADS7128_REG_LOW_TH_CH5 0x37
#define ADS7128_REG_HYSTERESIS_CH6 0x38
#define ADS7128_REG_HIGH_TH_CH6 0x39
#define ADS7128_REG_EVENT_COUNT_CH6 0x3A
#define ADS7128_REG_LOW_TH_CH6 0x3B
#define ADS7128_REG_HYSTERESIS_CH7 0x3C
#define ADS7128_REG_HIGH_TH_CH7 0x3D
#define ADS7128_REG_EVENT_COUNT_CH7 0x3E
#define ADS7128_REG_LOW_TH_CH7 0x3F
...
#define ADS7128_REG_GPO1_TRIG_EVENT_SEL 0xC5
#define ADS7128_REG_GPO2_TRIG_EVENT_SEL 0xC7
#define ADS7128_REG_GPO3_TRIG_EVENT_SEL 0xC9
#define ADS7128_REG_GPO4_TRIG_EVENT_SEL 0xCB
#define ADS7128_REG_GPO5_TRIG_EVENT_SEL 0xCD
#define ADS7128_REG_GPO6_TRIG_EVENT_SEL 0xCF
#define ADS7128_REG_GPO7_TRIG_EVENT_SEL 0xD1
 ...
 * INITIALIZATION
 */
uint8_t ADS7128_Initialize(ADS7128 *dev, I2C_HandleTypeDef *i2cHandlem, uint8_t num_samples);

/*
 * DATA ACQUISITON
 */

HAL_StatusTypeDef ADS7128_ReadTemperature(ADS7128 *dev);
HAL_StatusTypeDef ADS7128_ReadAccelerations(ADS7128 *dev);
